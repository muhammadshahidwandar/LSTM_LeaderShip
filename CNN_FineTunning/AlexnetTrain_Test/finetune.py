...
train_file = './TrainTestACCM/train2_O.txt'
val_file = './TrainTestACCM/test2.txt'
...
filewriter_path = "./finetune_alexnetT2_AC"
checkpoint_path = "./finetune_alexnetT2_AC"
...
Class_w = [1/10,1/5,1/5]
# Link variable to model output
score = model.fc8
fc6 = tf.convert_to_tensor(model.fc6,dtype=tf.float32,name = 'fc6')
fc7 = tf.convert_to_tensor(model.fc7,dtype=tf.float32,name = 'fc7')
y_pred = tf.nn.softmax(score,name="y_pred")
# List of trainable variables of the layers we want to train
var_list = [v for v in tf.trainable_variables() if v.name.split('/')[0] in train_layers]
wegt_score = tf.multiply(score,Class_w)
...
val_generator = ImageDataGenerator(val_file,horizontal_flip = True, shuffle = False) 
