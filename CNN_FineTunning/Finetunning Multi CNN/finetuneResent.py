...
tf.app.flags.DEFINE_string('training_file', './TrainTest/train1.txt', 'Training dataset file')
tf.app.flags.DEFINE_string('val_file', './TrainTest/test1.txt', 'Validation dataset file')
