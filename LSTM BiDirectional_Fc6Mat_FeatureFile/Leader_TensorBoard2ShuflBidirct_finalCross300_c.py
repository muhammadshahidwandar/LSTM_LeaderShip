...
with tf.Session() as sess:
    ...
    for Groups in TestVector:
        ...
        Y_test,X_test,VecLengT = LoadTestVadlid(240,Groups)
        Y_val,X_val,VecLengV = LoadTestVadlid(240,Groups2)
