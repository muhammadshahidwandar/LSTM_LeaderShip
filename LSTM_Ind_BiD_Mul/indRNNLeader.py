...
# Training Parameters
train = True
LOGDIR = './summarylayer2_RndStrd256TC3M2_2Layer_Finl512_2LIND'
# Num_Epochs = 30
#learnrate = 1e-3
...
with tf.Session() as sess:
    ...
    for Groups in TestVector:
        ...
        Y_test,X_test,VecLengT = LoadTestVadlid(350,Groups)
        Y_val,X_val,VecLengV = LoadTestVadlid(350,Groups2)
        Y_train,X_train = TrainDatasetLoad(350,Groups,Groups2)
        strtPont = 0
        lengt = len(X_train)
        testdrop = 0;
        traindrop = 0.30
