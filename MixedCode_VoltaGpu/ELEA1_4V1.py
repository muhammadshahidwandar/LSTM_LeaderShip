...
# Training Parameters
learning_rate = 1e-5
training_steps = 200#1000
batch_size = 20#128
display_step = 1000 #accuracy and loss on training batch will be displayed on consol after these steps
...
Label_file = '../ELEALabls7.mat';# Labels Matfile name
...
X_test = [];
#X_train = [];
for i in range(0, 50):#232):  ### 1 to 232 - Last meeting leave out, for test ranging from 219-232
...
with tf.Session() as sess:
    ...
    print('confusion Matrix',confusion_mat,ans, keras.utils.to_categorical(Y_test, num_classes))
    #saver = tf.train.Saver()
