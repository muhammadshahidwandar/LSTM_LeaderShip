...
X_test = [];
#X_train = [];
for i in range(100, 230):#232):  ### 1 to 232 - Last meeting leave out, for test ranging from 219-232
...
with tf.Session() as sess:
    ...
    for step in range(1, training_steps + 1):
        ...
        sess.run([train_op], feed_dict={X: batch_x, Y: batch_y,dropout:traindrop})
