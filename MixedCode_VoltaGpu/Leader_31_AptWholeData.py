...
X_test = [];
#X_train = [];
for i in range(0, 229):#232):  ### 1 to 232 - Last meeting leave out, for test ranging from 219-232
    ...
    while (endframIdx <= length):
        ...
        if ((i>213)&(i<230)):  # If index is less than 219, make it a part of Training data and label
            if(check!=5):
