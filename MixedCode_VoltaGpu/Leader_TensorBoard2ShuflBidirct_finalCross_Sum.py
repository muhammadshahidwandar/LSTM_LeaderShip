...
# Training Parameters
train = True
LOGDIR = './summarylayer2_RndStrd256TC3M2_2Layer_Finl285'
# Num_Epochs = 30
#learnrate = 1e-3
starter_learning_rate = 1e-3
training_steps = 3500  # 116.
batch_size = 20  # 128
...
with tf.Session() as sess:
    ...
    for Group in TestVector:
        ...
        Y_test,X_test = LoadTest(270,Groups)
        Y_val,X_val = LoadValidt(270,Groups2)
        Y_train,X_train = TrainDatasetLoad(270,Groups,Groups2)
        strtPont = 0
        lengt = len(X_train)
        testdrop = 0;
        traindrop = 0
        ...
        for step in range(1, training_steps + 1):
            ...
            if ((strtPont + batch_size) < lengt - batch_size):
                ...
                del X_train, Y_train
                random_strid = np.random.randint(270, 380, 1)
