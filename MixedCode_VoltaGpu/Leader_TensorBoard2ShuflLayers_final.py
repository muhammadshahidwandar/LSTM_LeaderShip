...
# Training Parameters
train = True
LOGDIR = './summarylayer2_RndStrd256TC3M2_2Layer_FinlSum'
# Num_Epochs = 30
#learnrate = 1e-3
...
with tf.Session() as sess:
    ...
    for Group in TestVector:
        ...
        Y_test,X_test = LoadTest(40,Groups)
        Y_val,X_val = LoadValidt(40,Groups2)
        Y_train,X_train = TrainDatasetLoad(40,Groups,Groups2)
        strtPont = 0
        lengt = len(X_train)
        testdrop = 0;
        traindrop = 0.60
        ...
        for step in range(1, training_steps + 1):
            ...
            if ((strtPont + batch_size) < lengt - batch_size):
                ...
                del X_train, Y_train
                random_strid = np.random.randint(32, 96, 1)
