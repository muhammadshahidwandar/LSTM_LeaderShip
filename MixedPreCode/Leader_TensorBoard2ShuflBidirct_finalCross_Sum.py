...
with tf.Session() as sess:
    ...
    for Groups in TestVector:
        ...
        Y_test,X_test = LoadTest(80,Groups)
        Y_val,X_val = LoadValidt(80,Groups2)
        Y_train,X_train = TrainDatasetLoad(80,Groups,Groups2)
        strtPont = 0
        lengt = len(X_train)
        testdrop = 0;
        traindrop = 0.65
