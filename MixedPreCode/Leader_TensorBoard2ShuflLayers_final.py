...
LeaveOneMeeting = [0, 13, 37, 53, 74, 94, 118, 142, 150, 174, 190, 214, 230]
...
with tf.Session() as sess:
    ...
    for Group in TestVector:
        ...
        Y_test,X_test = LoadTest(230,Groups)
        Y_val,X_val = LoadValidt(230,Groups2)
        Y_train,X_train = TrainDatasetLoad(230,Groups,Groups2)
        strtPont = 0
        lengt = len(X_train)
        testdrop = 0;
        traindrop = 0.60
        ...
        for step in range(1, training_steps + 1):
            ...
            if ((strtPont + batch_size) < lengt - batch_size):
                ...
                del X_train, Y_train
                random_strid = np.random.randint(180, 320, 1)
